...
model = load_model(r'D:\Kuliah\semester 5\Pembelajaran Mesin dan Mendalam\Tugas6_A_11844\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1844")  # Ganti XXXX dengan 4 digit NPM terakhir
